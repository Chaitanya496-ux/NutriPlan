...
## Flowchart
The flow of the system begins when the user opens the application and selects the dishes they are familiar with. The system then retrieves the nutritional information related to the selected dishes and processes this data to generate a balanced meal plan. Based on the generated plan, a list of required ingredients is prepared, and a WhatsApp notification is sent to a family member to assist with grocery planning.
